...
Rendering::Material::Material(const Rendering::MaterialPreset& preset)
...
void
Rendering::Material::updateBasedOnPreset()
{
    ...
    if (materialPreset != MaterialPreset::CUSTOM) {
        switch (materialPreset) {
            case MaterialPreset::EMERALD:
                ...
                properties.diffuse = glm::vec3(0.07568f, 0.61424f, 0.07568f);
            ...
            case MaterialPreset::RUBY:
                ...
                properties.diffuse = glm::vec3(0.61424f, 0.04136f, 0.04136f);
                properties.specular =
            ...
            case MaterialPreset::TURQUOISE:
                ...
                properties.specular = glm::vec3(0.297254f, 0.30829f, 0.306678f);
                properties.shininess = 0.1f;
                break;
            case MaterialPreset::BRASS:
                properties.ambient = glm::vec3(0.329412f, 0.223529f, 0.027451f);
                properties.diffuse = glm::vec3(0.780392f, 0.568627f, 0.113725f);
                properties.specular =
            ...
            case MaterialPreset::GOLD:
                ...
                properties.diffuse = glm::vec3(0.75164f, 0.60648f, 0.22648f);
                properties.specular =
                  glm::vec3(0.628281f, 0.555802f, 0.366065f);
                properties.shininess = 0.4f;
                break;
            case MaterialPreset::SILVER:
                properties.ambient = glm::vec3(0.19225f, 0.19225f, 0.19225f);
                properties.diffuse = glm::vec3(0.50754f, 0.50754f, 0.50754f);
                properties.specular =
            ...
            case MaterialPreset::CYAN_PLASTIC:
                ...
                properties.diffuse = glm::vec3(0.0f, 0.50980392f, 0.50980392f);
                properties.specular =
...
void
Rendering::Material::setMaterialPreset(const MaterialPreset& preset)
{
    materialPreset = preset;
    updateBasedOnPreset();
}
