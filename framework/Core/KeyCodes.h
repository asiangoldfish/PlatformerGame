...
#define FW_KEY_WORLD_1 161      /* non-US #1 */
#define FW_KEY_WORLD_2 162      /* non-US #2 */
...
typedef uint32_t FW_KEY_BIT;
#define KEY_BIT(key) (1U << key)
#define FW_KEY_LEFT_SHIFT_BIT KEY_BIT(0)
#define FW_KEY_LEFT_CONTROL_BIT KEY_BIT(1)
#define FW_KEY_LEFT_ALT_BIT KEY_BIT(2)
#define FW_KEY_LEFT_SUPER_BIT KEY_BIT(3)
#define FW_KEY_RIGHT_SHIFT_BIT KEY_BIT(4)
#define FW_KEY_RIGHT_CONTROL_BIT KEY_BIT(5)
#define FW_KEY_RIGHT_ALT_BIT KEY_BIT(6)
#define FW_KEY_RIGHT_SUPER_BIT KEY_BIT(7)
