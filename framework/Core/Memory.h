 ...
 *
 * @details The Framework provides its own version of smart pointers. These features automatic memory management by reference
 * counting.
 */
...
namespace Framework {
     ...
     * @tparam Args Typename for the arguments to pass to the object's constructor
