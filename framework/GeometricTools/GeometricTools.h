...
namespace GeometricTools {
     ...
     */
	constexpr std::array<float, 2 * 3> UnitTriangle2D = {
     ...
     */
	constexpr std::array<float, 2 * 6> UnitSquare2D = {
		-0.25f, -0.25f,
		0.25f, -0.25f,
		-0.25f, 0.25f,
	 ...
	 * @return
	*/
	inline std::vector<float> UnitGridGeometry2D(int tilingX, int tilingY, float sizeX = 1.0f, float sizeY = 1.0f)
	{
